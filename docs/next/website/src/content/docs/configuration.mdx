...
A horizontal trackpad swipe or mouse wheel anywhere on the tab row switches tabs; a wheel takes a few notches per tab. The focused tab's highlight slides toward the neighbor as you swipe and snaps back if you stop short; past either end it wraps to the other end.
